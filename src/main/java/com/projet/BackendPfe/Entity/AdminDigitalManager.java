...
public class AdminDigitalManager extends User {
	...
	public AdminDigitalManager(String username, String email,String nomPrenom, String password  , String image  , LocalDate date_inscription , String role , String reservePassword) {
