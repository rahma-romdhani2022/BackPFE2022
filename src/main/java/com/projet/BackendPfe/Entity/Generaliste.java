...
public class Generaliste extends User {
	...
	@OneToMany(targetEntity=Patient.class, mappedBy = "generaliste", cascade = CascadeType.ALL)
	...
	private List<Consultation>liste1=new ArrayList<Consultation>();
	 ...
	 public Generaliste(String username, String email,String nomPrenom ,  String password, String gender, long telephone ,  String image , LocalDate date_inscription  , String role ,String specialite , String reservePassword  ) {
	 ...
	 public Generaliste( String image) {
			this.image=image ;
		}
